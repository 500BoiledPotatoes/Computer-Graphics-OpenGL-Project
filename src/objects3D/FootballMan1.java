...
public class FootballMan1 {
    ...
    static {
        try {
            texture = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/bhead.png"));
            texture_body = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/stoneBody.png"));
            texture_body1 = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/woodBody.png"));
    ...
    public void drawFootballMan(float delta) {

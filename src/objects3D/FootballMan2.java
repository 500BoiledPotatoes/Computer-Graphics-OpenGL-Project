...
public class FootballMan2 {
    ...
    static {
        try {
            texture = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/ghead.png"));
            texture_body = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/redBody.png"));
            texture_body1 = TextureLoader.getTexture("PNG", ResourceLoader.getResourceAsStream("res/box.png"));
